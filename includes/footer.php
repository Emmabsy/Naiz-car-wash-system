<footer class="text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="col-span-1">
                ...
                <ul class="mt-2">
                    ...
                    <li><a href="https://twitter.com/" class="text-gray-400 hover:text-gray-200">Twitter</a></li>
                    <li><a href="https://www.instagram.com/" class="text-gray-400 hover:text-gray-200">Instagram</a></li>
                </ul>
            </div>
            <div class="col-span-1">
    ...
    <div class="bg-gray-900 py-3">
        <div class="container mx-auto text-center">
            <p class="text-gray-400">© 2023 Naiz. All rights reserved.</p>
        </div>
    </div>
</footer>