...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if ($_GET['rid']) {
        ...
        echo "<script>window.location.href ='completed-booking.php'</script>";
    }
?>
    <!DOCTYPE HTML>
    <html>
        ...
        <div class="flex">
            ...
            <div class="w-4/5 bg-white py-4 px-5">
                ...
                <div class="overflow-x-auto">
                    ...
                    <h2 class="mb-4 text-center text-3xl font-bold text-red-600">Complete Bookings</h2>
 ...
 where status='completed'";
                            ...
                            if ($query->rowCount() > 0) {
                                foreach ($results as $result) {                ?>
                                    <tr class="bg-yellow-100 border-solid border-2 border-gray-600">
                                ...
                                <tr>
                                    <td colspan="7" class="p-2 text-red-500">No Record found</td>
                                </tr>
                            <?php } ?>
