...
?>
    ...
    <head>
        <title>Naiz admin| Enquiries</title>
        <meta charset="UTF-8">
        ...
        <div class="flex">
            ...
            <div class="w-4/5 bg-white py-4 px-5">
                ...
                <div class="px-4 py-8">
                    <ol class="breadcrumb flex items-center text-gray-500">
                        ...
                        <li>
                            ...
                            <span class="text-gray-900 font-bold ">Enquiries</span>
                        </li>
                    </ol>
                </div>
                ...
                <div class="overflow-x-auto">
                    ...
                    <h2 class="mb-4 text-center text-3xl font-bold text-red-600">Manage Enquiries</h2>
                                    ...
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <td>
                                                ...
                                                <a href="manage-enquires.php?rid=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Do you really want to delete')">Delete</a>
                                            </td>
                                        <?php } ?>
                                    </tr>
                            <?php }
