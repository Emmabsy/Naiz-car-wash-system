...
<nav class="fixed top-0 z-50 bg-blue-900 w-full border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 ">
...
-->
                            <li>
                                <a href="change-pass.php" class="block px-6 bg-green-900 py-2 text-sm text-gray-100 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Profile</a>
                            </li>
                            <li>
                                <a href="logout.php" class="block px-4 py-2 bg-green-900 py-2 text-sm text-gray-100 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white">Sign out</a>
                            </li>
                        </ul>
                    </div>
